...
cljs.core.nil_iter = function cljs$core$nil_iter() {
  "undefined" === typeof cljs.core.t7916 && (cljs.core.t7916 = function(b, c) {
    this.nil_iter = b;
    this.meta7917 = c;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
    this.cljs$lang$protocol_mask$partition1$ = 0;
  }, cljs.core.t7916.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.t7916(this.nil_iter, c);
  }, cljs.core.t7916.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta7917;
  }, cljs.core.t7916.prototype.hasNext = function() {
    return !1;
  }, cljs.core.t7916.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t7916.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t7916.getBasis = function() {
    return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null, "nil-iter", "nil-iter", 1101030523, null), new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "arglists", "arglists", 1661989754), cljs.core.list(new cljs.core.Symbol(null, "quote", "quote", 1377916282, null), cljs.core.list(cljs.core.PersistentVector.EMPTY))], null)), new cljs.core.Symbol(null, "meta7917", "meta7917", -1194076216, null)], 
    null);
  }, cljs.core.t7916.cljs$lang$type = !0, cljs.core.t7916.cljs$lang$ctorStr = "cljs.core/t7916", cljs.core.t7916.cljs$lang$ctorPrWriter = function(b, c, d) {
    return cljs.core._write(c, "cljs.core/t7916");
  }, cljs.core.__GT_t7916 = function(b, c) {
    return new cljs.core.t7916(b, c);
  });
  return new cljs.core.t7916(cljs$core$nil_iter, cljs.core.PersistentArrayMap.EMPTY);
};
...
var curses = {core:{}};
curses.core.path = cljs.nodejs.require.call(null, "path");
curses.core.Electron = cljs.nodejs.require.call(null, "electron");
curses.core.BrowserWindow = cljs.nodejs.require.call(null, "browser-window");
curses.core.crash_reporter = cljs.nodejs.require.call(null, "crash-reporter");
curses.core._STAR_win_STAR_ = cljs.core.atom.call(null, null);
curses.core.app = curses.core.Electron.app;
curses.core._main = function() {
  curses.core.crash_reporter.start(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "companyName", "companyName", 2030952346), "NoneCo", new cljs.core.Keyword(null, "submitURL", "submitURL", -169159433), "http://example.com/"], null)));
  cljs.nodejs.process.on("error", function(a) {
    return console.log(a);
  });
  curses.core.app.on("window-all-closed", function() {
    return cljs.core.not_EQ_.call(null, cljs.nodejs.process.platform, "darwin") ? curses.core.app.quit() : null;
  });
  return curses.core.app.on("ready", function() {
    cljs.core.reset_BANG_.call(null, curses.core._STAR_win_STAR_, new curses.core.BrowserWindow(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "width", "width", -384071477), 800, new cljs.core.Keyword(null, "height", "height", 1025178622), 600], null))));
    cljs.core.deref.call(null, curses.core._STAR_win_STAR_).loadURL([cljs.core.str("file://"), cljs.core.str(curses.core.path.resolve(__dirname, "../index.html"))].join(""));
    return cljs.core.deref.call(null, curses.core._STAR_win_STAR_).on("closed", function() {
      return cljs.core.reset_BANG_.call(null, curses.core._STAR_win_STAR_, null);
    });
  });
};
cljs.nodejs.enable_util_print_BANG_.call(null);
cljs.core._STAR_main_cli_fn_STAR_ = curses.core._main;
cljs.nodejscli = {};
